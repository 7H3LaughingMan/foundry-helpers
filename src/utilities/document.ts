...
export function isDocumentType(value: unknown, documentName: "AmbientLight"): value is AmbientLightDocument<Scene | null>;
export function isDocumentType(value: unknown, documentName: "AmbientSound"): value is AmbientSoundDocument<Scene | null>;
...
export function isDocumentType(value: unknown, documentName: "Tile"): value is TileDocument<Scene | null>;
...
export function documentHasParent(value: Maybe<ActorDelta<TokenDocument | null>>): value is ActorDelta<TokenDocument>;
export function documentHasParent(value: Maybe<AmbientLightDocument<Scene | null>>): value is AmbientLightDocument<Scene>;
export function documentHasParent(value: Maybe<AmbientSoundDocument<Scene | null>>): value is AmbientSoundDocument<Scene>;
...
export function documentHasParent(value: Maybe<NoteDocument<Scene | null>>): value is NoteDocument<Scene>;
...
export function documentHasParent(value: Maybe<TileDocument<Scene | null>>): value is TileDocument<Scene>;
